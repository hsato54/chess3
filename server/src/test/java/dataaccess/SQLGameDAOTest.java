...
public class SQLGameDAOTest {
    ...
    AuthData auth = new AuthData("validAuthToken", "username");
    ...
    void updateGameTestPositive() throws DataAccessException {
        ...
        gameDAO.updateGame(auth.authToken(), updatedGame);
    ...
    void updateGameTestNegative() {
        ...
        assertThrows(DataAccessException.class, () -> gameDAO.updateGame(auth.authToken(), nonExistentGame),
